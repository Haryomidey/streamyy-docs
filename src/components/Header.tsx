      ...
      <div className="container mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="hidden sm:block px-4 py-2 bg-zinc-900 text-white text-sm font-bold rounded-xl hover:bg-zinc-800 transition-all shadow-lg shadow-zinc-200/50 active:scale-95">
              Get Started
            </button>
          </div>
        </div>
